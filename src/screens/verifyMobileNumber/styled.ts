...
/**
 * Name: MobileText
 * Desc: The text for mobile number
 */
 ...
 * Desc: it contain verify and resend button.
 */
...
/**
 * Name: MainContainer
 * Desc: it contain top and bottom view.
 */
